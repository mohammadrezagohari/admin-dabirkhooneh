...
//     return(
//         <>
//             <div ref={langRef} className="min-h-screen bg-base-200 flex items-center">
...
//                 </div>
//                 </div> */}
//                 <div className='w-24 h-24 bg-black flex flex-col gap-5'>
//                     <label>
//                         Choose your language:
//                     </label>
//                     <select onChange={changeLanguage} className="select select-sm mr-4" >
