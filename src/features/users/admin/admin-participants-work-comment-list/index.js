...
import {
  ...
  getAdminParticipantsWorkCommentList,
...
function AdminParticipantsWorkCommentList() {
  ...
  const showItemInfo = async (unique_key) => {
    const showResult = await getAdminParticipantsWorkCommentList(
      unique_key,
      userToken,
      apiCurrenPage,
      itemsPerPage
  ...
  // console.log("getAdminParticipantsWorkCommentList showDetails",showDetails);
...
export default AdminParticipantsWorkCommentList;
